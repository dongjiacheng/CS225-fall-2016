...
class BinaryTree
{
  ...
  public:
    ...
    T maxonleft(Node* subroot)const;
    
    T minonright(Node* subroot)const;
    ...
    void printPaths(vector<const BinaryTree<T>::Node *> &v,const Node * subroot) const;

    void printVector(vector<const BinaryTree<T>::Node *> v) const;
    ...
    int sumDistances(int brench, int &total, Node* subroot) const;
  private:
    Node* root;
